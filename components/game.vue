            ...
            <v-card tile>
              ...
              >
                ...
                >
                  ...
                  <v-icon v-else-if="box == 'o'" color="red"
    ...
    <v-dialog v-model="startDialog" persistent max-width="600">
      <v-card tile>
        <v-container class="py-5">
          ...
          <v-row justify="center">
            <v-col cols="auto">
              <v-icon size="150" color="red">mdi-circle-outline</v-icon>
            </v-col>
            <v-col cols="auto">
              <v-icon size="150" color="blue">mdi-close</v-icon>
            </v-col>
          </v-row>
          <v-row justify="center">
            <v-col cols="4">
        ...
        <v-container class="py-5">
          ...
          <v-row v-if="winner" justify="center">
            <v-col v-if="winner == 'o'" cols="auto">
              <v-icon size="20" color="red">mdi-circle-outline</v-icon>
            </v-col>
            <v-col v-else cols="auto">
              <v-icon size="20" color="blue">mdi-close</v-icon>
            </v-col>
          </v-row>
          <v-row justify="center">
            <v-col cols="auto">
            ...
            <v-col cols="auto">
              <v-btn :loading="loading" text block tile @click="reset"
                >Reset</v-btn
              >
            </v-col>
          </v-row>
  ...
  methods: {
    ...
    checkDiagonal(x, y) {
      ...
      if (x == y) {
        ...
        for (i = 0; i < this.tile; i++) {
          checklist.push(
            this.board[i][this.tile - 1 - i] == this.currentPlayer
          );
        }
      }
      return checklist.every((check) => !!check);
